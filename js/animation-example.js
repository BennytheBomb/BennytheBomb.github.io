...
const translation = new Vector3(0, 0, -360);
const rotation = new Vector3(190 * DEG2RAD, 40 * DEG2RAD, 320 * DEG2RAD);
...
function drawScene(now) {
  ...
  const matrix = Matrix4x4.perspective(fieldOfView, aspect);
  matrix.translate(translation.x, translation.y, translation.z);
  matrix.xRotate(rotation.x);
  matrix.yRotate(rotation.y);
  matrix.zRotate(rotation.z);
